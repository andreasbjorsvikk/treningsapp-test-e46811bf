        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1.5 max-w-[240px] mx-auto leading-relaxed">
              ...
              {mode === 'signup' && 'Start din treningsreise i dag'}
              {mode === 'forgot' && 'Vi hjelper deg med å komme tilbake'}
            </p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <Button
                ...
                onClick={async () => {
                  if (isNativePlatform()) {
                    const { error } = await nativeSignInWithOAuth('google');
              ...
              <Button
                ...
                onClick={async () => {
                  if (isNativePlatform()) {
                    const { error } = await nativeSignInWithOAuth('apple');
                    if (error) setError(error);
                  } else {
