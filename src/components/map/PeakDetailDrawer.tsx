...
import { Mountain, MapPin, Check, Loader2, ImageIcon } from 'lucide-react';
...
const PeakDetailDrawer = ({ peak, open, onClose, checkins, onCheckinSuccess }: PeakDetailDrawerProps) => {
  ...
  const handleCheckin = async () => {
    ...
    try {
      ...
      if (err?.code === 1) {
        ...
        toast.error(t('map.checkinError'));
      }
    } finally {
      setLoading(false);
    }
