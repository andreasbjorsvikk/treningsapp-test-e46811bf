      ...
      <div className="lg:grid lg:grid-cols-[auto_1fr] lg:gap-6 space-y-4 lg:space-y-0">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-center gap-2">
            <button
              onClick={() => { console.warn('[DEBUG-HAPTIC] ChartType bar'); hapticsService.impact('heavy'); setChartType('bar'); }}
            ...
            <button
              onClick={() => { console.warn('[DEBUG-HAPTIC] ChartType line'); hapticsService.impact('heavy'); setChartType('line'); }}
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${
                chartType === 'line'
                  ? 'bg-primary text-primary-foreground'
                  : 'bg-secondary text-secondary-foreground hover:bg-secondary/80'
