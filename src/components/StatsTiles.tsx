...
const StatsTiles = ({ sessions }: StatsTilesProps) => {
  ...
  return (
    <div className="grid grid-cols-4 gap-2">
      {tiles.map((tile) => (
        <div key={tile.label} className="glass-card bg-gradient-to-br from-foreground/14 via-muted/65 to-foreground/10 rounded-lg p-3 flex flex-col items-center text-center shadow-md">
