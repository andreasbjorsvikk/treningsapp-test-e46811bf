...
const en: Record<string, string> = {
  ...
  // Sync messages
  'sync.newSessions': '{n} new sessions synced from Strava',
  'sync.noNew': 'No new sessions to sync.',
  'sync.notConnected': 'Strava is not connected. Go to Settings → Sync.',
  'sync.failed': 'Sync failed',
  'sync.allUpToDate': 'Everything is already up to date.',
  'sync.newAndUpdated': '{new} new, {updated} updated sessions from Strava!',
  'sync.syncingAll': 'Syncing all history...',
  'sync.syncAllPrevious': 'Sync all previous sessions from Strava',
  'sync.deleteAllStrava': 'Delete all sessions imported from Strava',
  'sync.deleteConfirm': 'Are you sure you want to delete all sessions imported from Strava? This cannot be undone.',
  'sync.deletedCount': '{n} Strava sessions deleted.',
  ...
  'records.noDistanceSessions': 'No sessions with distance recorded yet.',
  ...
  'challenge.mostElevation': 'm',
  'challenge.noTarget.sessions': 'Most training sessions wins',
  ...
  'workoutDetail.sessionDetails': 'Session details',
  ...
  'userProfile.recentSessions': 'Recent sessions',
