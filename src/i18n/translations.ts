...
const no: Record<string, string> = {
  ...
  'help.trainingGoalsP2': '📌 <strong>Detaljerte mål:</strong> Du kan også sette mål for spesifikke aktiviteter, som «løp 100 km per måned» eller «3 styrkeøkter per uke».',
  ...
  'help.communityP2': '👥 <strong>Utfordringer:</strong> Opprett utfordringer med venner – hvem klarer flest km løping denne måneden?',
  ...
  'help.customizationP3': '🎨 <strong>Mørk modus:</strong> Bytt mellom lys og mørk modus med knappen nede til høyre.',
  'help.customizationP4': '🎨 <strong>Forsiden:</strong> Hold inne på en overskrift på forsiden for å endre rekkefølgen på seksjonene.',
  'help.footer': 'Spørsmål eller tilbakemeldinger? Vi jobber stadig med å forbedre appen! 💪',
...
const en: Record<string, string> = {
  ...
  'help.trainingGoalsP2': '📌 <strong>Detailed goals:</strong> You can also set goals for specific activities, like "run 100 km per month" or "3 strength sessions per week".',
  ...
  'help.communityP2': '👥 <strong>Challenges:</strong> Create challenges with friends – who can run the most km this month?',
  ...
  'help.customizationP3': '🎨 <strong>Dark mode:</strong> Switch between light and dark mode with the button at the bottom right.',
  ...
  'help.footer': 'Questions or feedback? We are constantly working to improve the app! 💪',
